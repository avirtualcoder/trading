...
<script type="text/javascript">
	function test(currentPage){
		...
		$.ajax({
			...
			data:{'currentPage':currentPage,'role':2},
			dataType:'json',
			success:function(data){
				...
				for(var i=0;i<g.length;i++){
						...
						"<input type='button' value='修改' class='showdata-input agree'/>"+
						"<input type='button' value='上架' class='showdata-input disagree'/>"+ 
						"</td></tr>"
				}
				...
				$(".inspect").click(function(){
					...
					$.ajax({
						...
						success:function(data){
							 ...
							 $("input[name='auditResult']").val(data[0].auditResult==2?"审核未通过":"状态错误");
							 $("input[name='publishUp']").val(data[0].publishUp);
						    ...
						    <c:forEach items="${glist}" var="g">
						        <tr>
									...
									<td>
										...
										<input type="button" value="上架" class="showdata-input publish" />
									</td>
						        </tr>
						    </c:forEach>
						</c:if>
